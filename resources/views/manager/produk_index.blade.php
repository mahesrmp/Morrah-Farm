                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                ...
                                <div class="col-5 text-center">
                                    <img src="{{ url('productimage') }}/{{ $produk->gambar }}" alt="Produk-img" class="img img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="text-right">
                                <!-- <a href="{{ route($routePrefix . '.edit', $produk->id)  }} "
                                                            class="btn btn-success btn-sm text-center"><i class="fas fa-edit"></i></a>

                                    <a href=" route($routePrefix . '.destroy', $produk->id) }}" class="btn btn-sm bg-danger">
                                ...
                                <a href="{{ route('produk.edit', $produk->id) }}" class="btn btn-success btn-sm text-center"><i class="fas fa-edit"></i></a>
